...
{
    // Logo
    $this->Image('images/icon.png',10,8,33);
    // Arial bold 15
    ...
    $this->Cell(35,10, utf8_decode('No. Mensajes'),1,0,'C',0);
    $this->Cell(50,10, utf8_decode('Nombre'),1,0,'C',0);
    $this->Cell(40,10, utf8_decode('Telefono'),1,0,'C',0);
...
while ($row = $resultado -> fetch_assoc()){
    $pdf -> Cell(35, 10, utf8_decode ($row['nomensaje']), 1, 0, 'C', 0);
